            ...
            public void onResponse(String response) {
                try {
                    ...
                    if(success){
                        ...
                        if(userValueItem.getDeposit() <= 0 || userValueItem.getDepositState()){
                            btn_person_deposit.setBackground(getResources().getDrawable(R.drawable.shape_corner_dark));
                        }else{
                            btn_person_deposit.setBackground(getResources().getDrawable(R.drawable.shape_corner));
                        }
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.btn_person_deposit:
                if(userValueItem != null && !userValueItem.getDepositState()) {
