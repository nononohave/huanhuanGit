...
import java.util.Map;
  ...
  */
        public class MultiPartStack extends HurlStack {	@SuppressWarnings("unused")
	...
	public HttpResponse performRequest(Request<?> request,
			Map<String, String> additionalHeaders) throws IOException, AuthFailureError {
                		...
                		if(!(request instanceof MultiPartRequestInterface)) {
 	 ...
 	 */
			...
			Request<?> request) throws AuthFailureError {
                		...
                		// Iterate the fileUploads
                        		Map<String, File> fileUpload = ((MultiPartRequestInterface) request).getFileUploads();
        		...
        		// Iterate the stringUploads
                		Map<String, String> stringUpload = ((MultiPartRequestInterface) request).getStringUploads();
