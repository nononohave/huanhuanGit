...
public class UpdateAgent {
    ...
    public interface OnPromptListener2 {
        void onPrompt2(ApkUpdateInfoBean bean);
    }
    ...
    public void checkFinish() {
        ...
        if (error != null) {
            ...
            if (info == null) {
                ...
                mTmpFile = new File(mContext.getExternalCacheDir(), "九牛易购");
                mApkFile = new File(mContext.getExternalCacheDir(), "九牛易购" + ".apk");
    ...
    private static class OnPrompt implements UpdateAgent.OnPromptListener {
        ...
        public void onPrompt(UpdateAgent agent) {
            ...
            String content = String.format("最新版本：%1$s\n新版本大小：%2$s\n\n更新内容\n%3$s", info.versionName, info.size, info.updateContent);
